...
ejecurar.addEventListener('click', () => {
    ...
    document.getElementById("clases").value = clase;
    document.getElementById("BinarioIp").value = IpConvertido;
    document.getElementById("mascarai").value = mascara;
...
const pintarM = (clase) => {
    ...
    datos = `
    <input type="text" name="Ipb" id="BinarioIp"
    readonly="readonly" value="${clase}" >
    
    `;

    clase.innerHTML = datos
}
